...
public class PartyExceptionHandler {
    ...
    public void exception(Long partySeq) {
        ...
        if (mapper.checkPartySeq(partySeq) == 0) {
            throw new MsgException("RE,존재하지 않는 모임입니다.");}
    }
    // R3, R4
